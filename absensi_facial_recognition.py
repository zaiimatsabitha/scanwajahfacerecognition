...
window.iconbitmap("C:/Users/zaiim/VSCode/absensi-face/logo.ico")
...
logo = Image.open("C:/Users/zaiim/VSCode/absensi-face/background.jpg")
...
lbl = Label(window, text="NIM", font=('helvetica', 15))
...
def read_kelas():
    ...
    combokelas['values'] =('')
    try:
        pd.read_csv('C:/Users/zaiim/VSCode/absensi-face/Mahasiswa/daftarkelas.csv')
        with open('C:/Users/zaiim/VSCode/absensi-face/Mahasiswa/daftarkelas.csv', newline='') as f:
            data = list(csv.reader(f))
            new_data = [a for i, a in enumerate(data) if a not in data[:i]] #hapus data duplikat
            with open('C:/Users/zaiim/VSCode/absensi-face/Mahasiswa/daftarkelas.csv', 'w', newline='') as t:
                write = csv.writer(t)
                write.writerows(new_data)
        with open('C:/Users/zaiim/VSCode/absensi-face/Mahasiswa/daftarkelas.csv', newline='') as csvfile:
        ...
        os.remove('C:/Users/zaiim/VSCode/absensi-face/Mahasiswa/daftarkelas.csv')
read_kelas()
...
def set_kelas():
    ...
    kelaswin.iconbitmap("C:/Users/zaiim/VSCode/absensi-face/logo.ico")
    width = 330
    height = 170
    ...
    def input_nama_kelas():
        ...
        if nama_kls == '':
            ...
            if not os.path.isdir('C:/Users/zaiim/VSCode/absensi-face/Mahasiswa'):
                os.mkdir('C:/Users/zaiim/VSCode/absensi-face/Mahasiswa')
            with open('C:/Users/zaiim/VSCode/absensi-face/Mahasiswa/daftarkelas.csv', 'a+', newline='') as csvfile:
    ...
    def hapus_satuan_kelas():
        ...
        if kelashapus == '':
            ...
            if checkvar.get() == 0:
                ...
                if tanyahapus == 'yes':
                    with open('C:/Users/zaiim/VSCode/absensi-face/Mahasiswa/daftarkelas.csv', 'r') as f:
                        reader = csv.reader(f)
                        list_kelas = list(reader)
                    list_kelas = [i[0] for i in list_kelas]
                    list_kelas.remove(kelashapus)
                    os.remove("C:/Users/zaiim/VSCode/absensi-face/Mahasiswa/daftarkelas.csv")
                    with open('C:/Users/zaiim/VSCode/absensi-face/Mahasiswa/daftarkelas.csv', 'w', newline='') as myfile:
                ...
                if tanyahapus == 'yes':
                    try:
                        shutil.rmtree('C:/Users/zaiim/VSCode/absensi-face/Mahasiswa'+kelashapus+'/')
                    except FileNotFoundError:
                        pass
                    with open('C:/Users/zaiim/VSCode/absensi-face/Mahasiswa/daftarkelas.csv', 'r') as f:
                        reader = csv.reader(f)
    ...
    def hapus_daftar_kelas():
        if checkvar.get() == 0:
            ...
            if tanyahapus == 'yes':
                try:
                    shutil.rmtree("C:/Users/zaiim/VSCode/absensi-face/Mahasiswa")
                    os.mkdir('Mahasiswa')
...
def penggunaan():
    ...
    penggunaanwin.iconbitmap("C:/Users/zaiim/VSCode/absensi-face/logo.ico")
...
def viewmhs():
    ...
    mhswin.iconbitmap("C:/Users/zaiim/VSCode/absensi-face/logo.ico")
    ...
    def buka_kelas():
        ...
        try:
            with open('C:/Users/zaiim/VSCode/absensi-face/Mahasiswa'+kelas_pilihan+'/DescMahasiswa.csv') as f:
...
def viewabs():
    ...
    abswin.iconbitmap("C:/Users/zaiim/VSCode/absensi-face/logo.ico")
    ...
    def show_csv():
        ...
        try:   
            ...
            tampil_path.configure(text='Buka Absensi', fg='red')
    ...
    scrollbarx.config(command=tree.xview)
    scrollbarx.pack(side=BOTTOM, fill=X)
    tree.heading('NPM', text="NIM", anchor=W)
    tree.heading('Nama', text="Nama", anchor=W)
    ...
    if not uye.get():
        pathabsensi='C:/Users/zaiim/VSCode/absensi-face/Absensi'
        show_csv()
    else:
        pathabsensi = uye.get()
        show_csv()
...
def tentang():
    mb.showinfo('Absensi Facial Recognition')

global portnum
portnum = IntVar()
def set_port():
    setportwin = Toplevel(window)
    setportwin.iconbitmap("C:/Users/zaiim/VSCode/absensi-face/logo.ico")
...
dropdown_view.add_command(label='C:/Users/zaiim/VSCode/absensi-face/Absensi', command=viewabs)
...
def cek_duplikat_NPM(npm,kelas):
    try:
        with open ('C:/Users/zaiim/VSCode/absensi-face/Mahasiswa'+kelas+'/DescMahasiswa.csv', 'r') as f:
            reader = csv.reader(f)
            list_kelas = list(reader)
        list_kelas = [i[0] for i in list_kelas]
...
def ambilgambar_intro():
    ...
    path_kelas = 'C:/Users/zaiim/VSCode/absensi-face/Mahasiswa'+nama_folder
...
def ambilgambar(path):   
    try:
        ...
        or all(x.isalpha() or x.isspace() for x in Nama)) and not kelas == '' and cek_duplikat_NPM(NPM,kelas) == False):
            ...
            xml_file_path = ('C:/Users/zaiim/VSCode/absensi-face/haarcascade_frontalface_default.xml')
...
def train_intro():
    ...
    intro_train.iconbitmap("C:/Users/zaiim/VSCode/absensi-face/logo.ico")
...
def traingambar(path):
    try:
        ...
        mukamuka,nomormhs = getgambardanlabel('C:/Users/zaiim/VSCode/absensi-face/Mahasiswa'+path+'/gambartraining')
        recognizer.train(mukamuka, np.array(nomormhs))
        if not os.path.exists('C:/Users/zaiim/VSCode/absensi-face/Mahasiswa'+path+'/hasiltraining/'):
            os.mkdir('C:/Users/zaiim/VSCode/absensi-face/Mahasiswa'+path+'/hasiltraining/')
        recognizer.save('C:/Users/zaiim/VSCode/absensi-face/Mahasiswa'+path+'/hasiltraining/Trainer.yml')
    ...
    if not nama_kelas_recog:
        mb.showerror('Tidak ada Input','Input kelas belum dimasukkan')
        intro_recog = "DefaultIntroValue"  # Define intro_recog with some default value
        intro_recog.focus_set()
    else:
        if not path_penyimpanan:
            path_penyimpanan = 'C:/Users/zaiim/VSCode/absensi-face/Absensi'
...
def kenali_intro():
    ...
    intro_recog.iconbitmap("C:/Users/zaiim/VSCode/absensi-face/logo.ico")
    ...
    def button_recog():
        ...
        if not nama_kelas_recog:
            ...
            if not path_penyimpanan:
                path_penyimpanan = 'C:/Users/zaiim/VSCode/absensi-face/Absensi'
                mb.showinfo("Direktori penyimpanan", "Direktori penyimpanan ada di file absensi.\n File absensi akan disimpan di direktori aplikasi")
                kenaliwajah(nama_kelas_recog, penyimpanan=path_penyimpanan)
            else:
                kenaliwajah(nama_kelas_recog,penyimpanan=path_penyimpanan)
...
def kenaliwajah(kelas, penyimpanan):
    try:
        ...
        recognizer.read('C:/Users/zaiim/VSCode/absensi-face/Mahasiswa'+kelas+'/hasiltraining/Trainer.yml')
        
        faceCascade = cv2.CascadeClassifier('C:/Users/zaiim/VSCode/absensi-face/haarcascade_frontalface_default.xml')    
        df=pd.read_csv('C:/Users/zaiim/VSCode/absensi-face/Mahasiswa'+kelas+'/DescMahasiswa.csv')
        df.reset_index(drop=True)
        cam = cv2.VideoCapture(portnum.get())
        font = cv2.FONT_HERSHEY_SIMPLEX        
        nama_kolom =  ['NIM','Nama','Tanggal','Waktu']
        ...
        try:
            ...
            os.mkdir('C:/Users/zaiim/VSCode/absensi-face/Absensi')
            absensi.to_csv(fileName,index=False)
        cam.release()
        cv2.destroyAllWindows()
        #print(absensi)
...
img_kenali = Image.open("C:/Users/zaiim/VSCode/absensi-face/kenali.jpg")
...
img_rekam = Image.open("C:/Users/zaiim/VSCode/absensi-face/rekam.jpg")
...
img_back = Image.open("C:/Users/zaiim/VSCode/absensi-face/kembali.jpg")
